a second reusable chart iteration, where are dataset-specific things are specified in configuration and abstracted out of the code

now testing a predictive modeling example dataset 
